...
\newcommand{\abstractFR}{\input{these_resume}}
...
\newcommand{\abstractEN}{\input{these_abstract}}
...
\begin{textblock*}{61mm}(16mm,3mm)
	...
	\noindent\includegraphics[height=24mm]{images/ed/\logoEd.jpeg}
\end{textblock*}
...
\textblockcolour{white}
\includegraphics[width=20mm]{images/UPSACLAY-petit}
\end{textblock*}
\end{singlespace}